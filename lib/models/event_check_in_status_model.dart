...
//
//     final eventCheckInStatusModel = eventCheckInStatusModelFromJson(jsonString);

import 'dart:convert';

EventCheckInStatusModel eventCheckInStatusModelFromJson(String str) => EventCheckInStatusModel.fromJson(json.decode(str));

String eventCheckInStatusModelToJson(EventCheckInStatusModel data) => json.encode(data.toJson());

class EventCheckInStatusModel {
  EventCheckInStatusModel({
    this.statusCode,
    this.message,
    this.status,
    this.data,
  ...
  factory EventCheckInStatusModel.fromJson(Map<String, dynamic> json) => EventCheckInStatusModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    langs: json["langs"] == null ? null : DataLangs.fromJson(json["langs"]),
...
class DataLangs {
  ...
  factory DataLangs.fromJson(Map<String, dynamic> json) => DataLangs(
