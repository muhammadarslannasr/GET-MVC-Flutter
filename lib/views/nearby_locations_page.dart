      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              ...
              onPressed: () {
                productController.fetchNearbyEvents();
              })
        ],
      ),
      body: Column(
          ...
          Expanded(
            child: Obx(() {
              if (productController.isLoading.value)
                ...
                return productController.nearbyEventsModel.value.data == null
                    ? Container()
                    : ListView.builder(
                        itemCount: productController
                            .nearbyEventsModel.value.data.length,
                        itemBuilder: (BuildContext context, int index) {
                          return ListTile(
                            leading: CircleAvatar(
                              radius: 30.0,
                              backgroundImage: NetworkImage(
                                productController.nearbyEventsModel.value
                                            .data[index].langs.en.image !=
                                        null
                                    ? productController.nearbyEventsModel.value
                                        .data[index].langs.en.image
                            ...
                            title: Text(
                              productController.nearbyEventsModel.value
                                  .data[index].langs.en.title,
                              style: TextStyle(fontWeight: FontWeight.w700),
                            ),
                            subtitle: Text(
                              productController.nearbyEventsModel.value
                                  .data[index].langs.en.address,
